      ...
      <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm p-5">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="px-5 py-2 text-sm font-medium rounded-lg bg-orange-500 text-white hover:bg-orange-600 transition-colors disabled:opacity-50"
          >
            {actionLoading ? "..." : "추가"}
          </button>
        </div>
                ...
                <div key={r.requesterId} className="px-4 py-3 flex items-center gap-3">
                  ...
                  <div className="flex gap-2 shrink-0">
                    <button
                      ...
                      className="px-3 py-1.5 text-xs font-medium rounded-lg bg-orange-500 text-white hover:bg-orange-600 transition-colors disabled:opacity-50"
                    >
                      수락
                    </button>
                    <button
                      onClick={() => handleDecline(r.requesterId)}
                      className="px-3 py-1.5 text-xs font-medium rounded-lg bg-gray-200 text-gray-600 hover:bg-gray-300 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600 transition-colors"
                    >
                      거절
                    </button>
                  </div>
